...
namespace Parlot.Compilation
{
    ...
    public static class ExpressionHelper
    {
        ...
        public static MemberExpression UseNewLines<TParseContext>(this CompilationContext<TParseContext, char> context) where TParseContext : ParseContextWithScanner<char> => Expression.Property(context.ParseContext, nameof(Fluent.Char.ParseContext.UseNewLines));
